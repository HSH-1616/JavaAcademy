...
<section id="enroll-container">
	...
	<form action="<%=request.getContextPath()%>/memberenrollend.do" method="post">
		<table>
			...
			<tr>
				...
				<td><input type="tel" placeholder="(-없이)01012345678"
					name="phone" id="phone" maxlength="11"><br></td>
			</tr>
			<tr>
				<th>주소</th>
			...
			<tr>
				<th>성별</th>
				<td><input type="radio" name="gender" value="M" id="gender0">
		...
		<input type="submit" value="가입" onclick="return fn_validation2();"> <input
			type="reset" value="취소">
	</form>
</section>
<script>
