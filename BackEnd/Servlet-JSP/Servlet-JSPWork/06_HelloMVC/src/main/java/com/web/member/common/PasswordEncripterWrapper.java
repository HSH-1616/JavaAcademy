...
public class PasswordEncripterWrapper extends HttpServletRequestWrapper{
	public PasswordEncripterWrapper(HttpServletRequest request) {
		super(request);
	}
	...
	private String getSHA512(String oriVal) {
		...
		//생성된 MessageDigest클래스를 이용해서 원본값에 대한 암호화 처리
