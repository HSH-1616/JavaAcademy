<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.List,com.web.notice.dto.Notice"%>
<%
...
<%@ include file="/views/common/header.jsp"%>
  ...
  <h2>공지사항 작성</h2>
    <form action="<%=request.getContextPath() %>/notice/insertNotice.do" method="post" enctype="multipart/form-data">
        ...
        <tr>
            <th>제 목</th>
            <td><input type="text" name="noticeTitle" required></input></td>
        </tr>
        <tr>
            <th>작성자</th>
            <td><input type="text" name="noticeWriter" value=<%=loginMember.getUserId()%> readonly></input></td>
        </tr>
        <tr>
            <th>첨부파일</th>
