...
public class BasicVariable {
	public static void main(String[] args) {
		...
		byte bnum; //byte[] 바이너리 파일을 저장할때 사용 (사진, 동영상, 음악...)
		short snum;
		int inum; //일반적인 숫자값을 저장할때 사용
		long lnum; //int를 넘어서는 값을 저장할때 사용
		
		//실수형 *실제값이 아닌 계산에 필요한 값을 저장(지수, 가수)
		//float : 4byte 크기의 실수를 저장
		//double : 8byte 크기의 실수를 저장
		float fnum;
		double dnum;
		...
		//1. 변수명은 대소문자를 구분한다. 명칭에 길이에는 제한이 없다.
		int testNum;
		int testnum;
		double testtesttesttesttesttesttesttesttesttesttesttest;
		...
		//String t_est;//변수명 중복 error
		//if(t_est) {
		//	int tes$t;}
		
		
		//6. 변수선언할때 동일자료형에 대한 여러변수를 한번에 선언할수 있다.
		int a;
		int b;
		int c;
		int d;
		...
		//int a,b,c,d,e; // 한번에 변수선언 가능
		
	}//main 닫기
	String t_est;//동일영역이 아니라서 가능
}
