...
//		new LoopPracticeEx().practice1();
//		new LoopPracticeEx().practice2();
//		new LoopPracticeEx().practice3();
//		new LoopPracticeEx().practice4();
//		new LoopPracticeEx().practice5();
//		new LoopPracticeEx().practice6();
//		new LoopPracticeEx().practice7();
//		new LoopPracticeEx().practice8();
//		new LoopPracticeEx().practice9();
//		new LoopPracticeEx().practice10();
//		new LoopPracticeEx().practice11();
	}
