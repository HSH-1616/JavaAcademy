...
%>
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/productpage/productPage.css" />
 <section>
      <div class="product">
        ...
        <div class="productInfo">
          ...
          <h2 id="productName">
            <%=p.getTitle() %>
            <span id="productStatus"><p><%=p.getSellStatus() %></p></span>
          </h2>
...
<%=p.getExplanation() %>
          ...
          <div id="introTag">
            ...
            <div class="introBox">
              ...
              <p><a href=""><%=p.getCategoryId() %></a></p>
            </div>
            <div class="introBox">
              <ion-icon name="pricetag-sharp"></ion-icon> <span>상품태그</span>
              <p>
                <a href=""> <%=p.getKeyword() %> </a> <a href=""> #아이폰12 </a>
                <br />
                <a href=""> #아이폰 프로 맥스</a>
              </p>
            </div>
        ...
        <div class="shopInfo">
          ...
          <div class="shopProfile">
            <div id="profile">
              <a href=""><img src="<%=request.getContextPath()%>/images/productpage/프로필.jpg" alt="" /></a>
            </div>
            <div id="userInfo">
          ...
          <div id="otherProduct">
            ...
            <div id="opContainer">
              <div class="opProduct">
                <a href="">
                  <img src="<%=request.getContextPath()%>/images/productpage/추가상품1.jpg" alt="" />
              ...
              <div class="opProduct">
                <a href="">
                  <img src="<%=request.getContextPath()%>/images/productpage/추가상품2.jpg" alt="" />
              ...
              <div class="opProduct">
                <a href="">
                  <img src="<%=request.getContextPath()%>/images/productpage/추가상품3.jpg" alt="" />
                  <p class="opPrice">12,345원</p>
      ...
      <div id="comment">
        ...
        <div class="cmtContainer">
          <div class="cmtProfile">
            <a href="">
              <img src="<%=request.getContextPath()%>/images/productpage/댓글1.jpg" alt="" />
            </a>
        ...
        <div class="reComment">
          <div class="cmtProfile">
            <a href="">
              <img src="<%=request.getContextPath()%>/images/productpage/프로필.jpg" alt="" />
            </a>
        ...
        <div class="cmtContainer">
          <div class="cmtProfile">
            <a href="">
              <img src="<%=request.getContextPath()%>/images/productpage/댓글2.jpg" alt="" />
            </a>
      ...
      <div id="relateProduct">
        ...
        <div id="rpContainer">
          <div class="rProduct">
            <a href=""
              ><img src="<%=request.getContextPath()%>/images/productpage/연관1.jpg" alt="" />
              <p>갤럭시23</p></a
            >
          </div>
          <div class="rProduct">
            <a href=""
              ><img src="<%=request.getContextPath()%>/images/productpage/연관2.jpg" alt="" />
              <p>중고폰매입 파손폰매입...</p></a
            >
          </div>
          <div class="rProduct">
            <a href=""
              ><img src="<%=request.getContextPath()%>/images/productpage/연관3.jpg" alt="" />
              <p>아이폰 12프로맥스 128기...</p></a
            >
          </div>
          <div class="rProduct">
            <a href=""
              ><img src="<%=request.getContextPath()%>/images/productpage/연관4.jpg" alt="" />
              <p>파손폰매입 중고폰매입...</p></a
            >
          </div>
          <div class="rProduct">
            <a href=""
              ><img src="<%=request.getContextPath()%>/images/productpage/연관5.jpg" alt="" />
