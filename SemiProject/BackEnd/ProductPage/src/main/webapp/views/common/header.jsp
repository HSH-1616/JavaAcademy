...
<html lang="en">
  <head>
    ...
    <title>Hifive-productPage</title>
    <link
    ...
    <link rel="icon" href="./img/header/파비콘.png" type="image/x-icon" />
    <script
      type="module"
      ...
      <div id="headerContainer">
        <div id="fixedContainer">
          <div class="loginSerivce">
            <a href="http://www.naver.com" id="login">로그인</a>
            <a href="http://www.naver.com" id="enroll">회원가입</a>
            <a href="http://www.naver.com" id="service">고객센터</a>
          </div>
          <div class="headerMain">
            <div class="logo">
              <a href="">
                <img src="./img/header/hifive로고.png" alt="" />
              </a>
            </div>
            <div class="searchBar">
              <div class="searchDetail">
                ...
                <button class="search" onclick="searchData()">
                  <img src="./img/header/돋보기.png" alt="" />
                </button>
              </div>
            </div>
