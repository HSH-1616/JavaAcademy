...
COMMENT ON COLUMN "PRODUCT"."SHOP_ID" IS '상점ID(FK)';
COMMENT ON COLUMN "PRODUCT"."SUBCATEGORY_ID" IS '세부카테고리ID(FK)';
COMMENT ON COLUMN "PRODUCT"."AREA_ID" IS '읍,면,동 지역ID(FK)';
...
INSERT INTO PRODUCT VALUES (SEQ_PRODUCT_ID.nextval, 'user01', '아이폰14 팝니다', '새상품', DEFAULT, 350000, DEFAULT, DEFAULT, '아이폰14 새상품 팝니다~ 연락주세요!', '아이폰,아이폰14', '1', '1', '1')
